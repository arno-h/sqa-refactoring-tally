...
public class Constants {
    static public final Integer FL_CURRENCY_CODE = 1;
    static public final Integer FL_CURRENCY_CODE_FOR_WEIRD_BANK = 2;
    static public final Integer USD_CURRENCY_CODE = 3;
    static public final Integer EUR_CURRENCY_CODE = 4;

    static public final String CURRENCY_FL = "FLD";

...
public class TestConfirmationLetterTally {
    ...
    public void testTally() {
        ...
        ltr2.add(new TempRecord("+", eur, BigDecimal.valueOf(130)));
        ltr2.add(new TempRecord("+", eur, BigDecimal.valueOf(180)));
        ltr2.add(new TempRecord("-", fl, BigDecimal.valueOf(2130)));
        ltr2.add(new TempRecord("-", fl, BigDecimal.valueOf(270)));
